...
const celebrityName = ["张子豪", "杨紫", "汤晶媚", "任敏", "宋雨琦", "侯明昊", "刘亦菲", "林志颖", "陈乔恩", "王鹤棣",
    ...
    "莫文蔚", "1983组合", "安又琪", "朴树", "汪峰", "张宇", "田震", "金海心", "蔡琴", "那英", "张卫健", "杨坤", "徐峥",
    ...
    "李咏", "周深", "欧阳娜娜", "刘威", "杨子姗", "边伯贤", "周密", "梁浩贤", "尉迟泽", "房祖名", "金钟大", "沈梦辰", "何赛飞",
    ...
    "陈立农", "李马克", "向佐", "钟丽缇", "张伦硕", "NCTDREAM", "李楷灿", "李帝努", "朴志晟", "黄仁俊", "钟辰乐",
    "罗渽民", "楷灿HAECHAN", "志晟_JISUNG", "刘晓庆", "刘奕君", "宋祖儿", "胡宇威", "陈庭妮", "陈庭妮", "张汉杰", "孙菲菲",
    "田曦薇", "易梦玲", "尚雯婕", "丛浩楠", "聂心远", "朴宝英", "朴炯植", "王子异", "包上恩", "李佳琦", "薇娅", "宋威龙",
    "罗翔", "罗大美", "林有慧", "任权", "薛小婉", "具俊晔", "李善均", "papi酱", "于文文", "权志龙", "刘亚仁", "辛巴", "辛芷蕾",
    "黄米依", "黄景瑜", "王雨馨", "朴有天", "惠英红", "惠英紅", "崔秀彬", "洪胜汉", "李旼赫", "金珉奎", "朴秀彬", "洪知秀",
    "崔秀英", "金泳勋", "李硕珉", "唐禹哲", "王安宇", "秦海璐", "刘些宁", "基辛格", "周海媚", "纪凌尘", "詹雯婷", "庄达菲",
    "孙珍妮", "丁禹兮", "李栋旭", "黄泽锋", "具俊晔", "朴彩英", "郑燕姿", "李昀锐", "旺仔小乔", "傅首尔", "高雅轩"

// 容易混淆的名词名：黑鸭子 F4 5566 阿杜 五月天 阿牛 白雪 艾伦 海陆 中国娃娃 老狼 俊辉 阿宝 清醒 文章 香香 beyond  米雪
// 容易混淆的常见名：马可 小雪  黎明  亮亮  豆豆  萧萧
];
