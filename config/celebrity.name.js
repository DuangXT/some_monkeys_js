...
const celebrityName = ["张子豪", "杨紫", "汤晶媚", "任敏", "宋雨琦", "侯明昊", "刘亦菲", "林志颖", "陈乔恩", "王鹤棣",
    ...
    "孙怡", "黄征", "曹方", "魏晨", "何洁", "金珉锡", "杨幂", "韩雪", "廖凡", "赵传", "周慧敏", "王一栩", "黎明",
    "田馥甄", "杨丞琳", "罗志祥", "林宥嘉", "邓紫棋", "容祖儿", "蔡卓妍", "五熊", "陈德修", "阿信", "胡夏", "郭品超", "陈怡蓉",
    ...
    "陈星", "范晓萱", "张瑶", "崔健", "亮亮", "萧潇", "李宗盛", "柯以敏", "誉晌早", "许茹芸", "郭峰", "马郁", "2moro", "陈小春",
    ...
    "欧豪", "秦昊", "金东", "张涵予", "叶祖新", "杨乐", "刘青云", "张丹凤", "李连杰", "张译", "刘浩然", "陈学东", "杨硕",
